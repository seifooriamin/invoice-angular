<?php
    ...
    // query products
    $stmt = $estimate->search($keywords,$from_record_num, $records_per_page);
    $num = $stmt->rowCount();
    ...
    if($num>0){
        ...
        // include paging
        $total_rows=$estimate->count_search($keywords);
        $page_url="{$home_url}estimate/search.php?s=".$keywords."&";
