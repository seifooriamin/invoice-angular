<?php
    ...
    if(
        ...
        if($invoice_rows->create()){
            ...
            // tell the user
            echo json_encode(array("message" => "New invoice row has been registered."));
        }
        ...
        // if unable to create the product, tell the user
            ...
            // tell the user
            echo json_encode(array("message" => "Unable to register new invoice row."));
        }
    }
