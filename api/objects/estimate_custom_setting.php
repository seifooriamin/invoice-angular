...
class Estimate_custom_setting
{
    private $conn;
    private $table_name="estimate_custom_setting";
    ...
    function readOneByEstimateID() {
        $query="SELECT *
                FROM " . $this->table_name . " egs
                WHERE egs.estimate_id = ?";
    ...
    function delete(){
        ...
        // sanitize
        $this->invoice_id=htmlspecialchars(strip_tags($this->estimate_id));
